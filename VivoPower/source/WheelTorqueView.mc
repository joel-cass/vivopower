...
class WheelTorqueView extends Ui.View {

	var _title = "Wheel Torque";
	var _label1 = "Power";
	var _value1 = "---";
	var _label2 = "Torque";
	var _value2 = "---";
    ...
    function onShow() {
    	VivoPowerApp.sensor.addListener(method(:updateValues), AntPowerSensor.PAGE_TORQUE_WHEEL);
    }
    ...
    //! memory.
    function onHide() {
    	VivoPowerApp.sensor.clearListeners(AntPowerSensor.PAGE_TORQUE_WHEEL);
    }
