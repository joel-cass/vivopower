...
class TorqueFrequencyView extends Ui.View {

	var _title = "Torque Frequency";
	var _label1 = "Power";
	var _value1 = "---";
	var _label2 = "Torque";
	var _value2 = "---";
    ...
    function onShow() {
    	VivoPowerApp.sensor.addListener(method(:updateValues), AntPowerSensor.PAGE_TORQUE_FREQUENCY);
    }
    ...
    //! memory.
    function onHide() {
    	VivoPowerApp.sensor.clearListeners(AntPowerSensor.PAGE_TORQUE_FREQUENCY);
    }
